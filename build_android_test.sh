...
./gradlew assemble
cd $BASE_DIR
jarsigner -storepass @bsolute -tsa http://timestamp.digicert.com -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore yasuke.keystore $BASE_DIR/platforms/android/build/outputs/apk/release/android-release-unsigned.apk yasuke
/Users/aardvocate/Library/Android/sdk/build-tools/24.0.2/zipalign -v 4  $BASE_DIR/platforms/android/build/outputs/apk/release/android-release-unsigned.apk yasuke.apk

mv yasuke.apk XendFiTest.$VERSION.apk
...
scp yasukeTest.$VERSION.apk xend@yasuke.com:/var/www/html/releases/
echo "Done"
